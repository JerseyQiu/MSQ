...
{
    /// <summary />
    [PostRegenerateAvsForImageSeriesActivity_DisplayName]
    [DICOM_ActivityGroup]
    [ImageSeries_Category]
    public class PostRegenerateAvsForImageSeries : MosaiqCodeActivity
    {
        [Import(RequiredCreationPolicy = CreationPolicy.NonShared)]
        private IProcessImageSeries _regenerateAvsVolume;
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            string localStatus = _regenerateAvsVolume.PostRegenerateAvsForImageSeries(UnitId.Get(context));
