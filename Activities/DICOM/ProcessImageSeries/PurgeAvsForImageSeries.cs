...
{
    /// <summary />
    [PurgeAvsForImageSeriesActivity_DisplayName]
    [DICOM_ActivityGroup]
    [PurgeAVS_Category]
    public class PurgeAvsForImageSeries : MosaiqCodeActivity
    {
        [Import(RequiredCreationPolicy = CreationPolicy.NonShared)]
        private IProcessImageSeries _purgeAvsVolume;
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            string localStatus = _purgeAvsVolume.PurgeAvsForImageSeries(UnitId.Get(context));
