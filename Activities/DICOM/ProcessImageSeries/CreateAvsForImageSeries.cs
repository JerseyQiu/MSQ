...
{
    /// <summary />
    [CreateAvsForImageSeriesActivity_DisplayName]
    [DICOM_ActivityGroup]
    [ImageSeries_Category]
    public class CreateAvsForImageSeries : MosaiqCodeActivity
    {
        [Import(RequiredCreationPolicy = CreationPolicy.NonShared)]
        private IProcessImageSeries _createAvsVolume;
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            string localStatus = _createAvsVolume.CreateAvsForImageSeries(UnitId.Get(context));
