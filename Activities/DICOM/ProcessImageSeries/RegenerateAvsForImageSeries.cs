...
{
    /// <summary />
    [RegenerateAvsForImageSeriesActivity_DisplayName]
    [DICOM_ActivityGroup]
    [ImageSeries_Category]
    public class RegenerateAvsForImageSeries : MosaiqCodeActivity
    {
        [Import(RequiredCreationPolicy = CreationPolicy.NonShared)]
        private IProcessImageSeries _regenerateAvsVolume = null;
