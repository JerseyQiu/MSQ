...
{
    /// <summary> </summary>
    [ProcessGenericSpatialRegistration_DisplayName]
    [DICOM_ActivityGroup]
    [SpatialRegistration_Category]
    public class ProcessGenericSpatialRegistrationObject : MosaiqCodeActivity
    {
        /// <summary> </summary>
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            bool result = _processSpatialRegistrationObject.CreateSimpleGenericSRORegistrationFoRREntries(nDcmInstanceId);
