...
namespace Impac.Mosaiq.IQ.Activities.DICOM.ProcessStructureSet
{
    ...
    /// <summary> </summary>
    [CreateAnatomySetsActivity_DisplayName]
    [DICOM_ActivityGroup]
    [RTStructureSet_Category]
    public class CreateAnatomySets : MosaiqCodeActivity
    {
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            string localStatus = _createAnatomySets.ProcessStructureSetCreateAnatomySets(UnitId.Get(context));
