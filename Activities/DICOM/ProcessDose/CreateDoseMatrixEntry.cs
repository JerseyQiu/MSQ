...
namespace Impac.Mosaiq.IQ.Activities.DICOM.ProcessDose
{
    ...
    /// <summary> </summary>
    [CreateDoseMatrixEntry_DisplayName]
    [DICOM_ActivityGroup]
    [RTDose_Category]
    public class CreateDoseMatrixEntry : MosaiqCodeActivity
    {
        [Import(RequiredCreationPolicy = CreationPolicy.NonShared)]
        private IProcessDose _createDoseMatrixEntry;
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            string localStatus = _createDoseMatrixEntry.CreateDoseMatrixEntry(UnitId.Get(context));
