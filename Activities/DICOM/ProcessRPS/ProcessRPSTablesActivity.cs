...
namespace Impac.Mosaiq.IQ.Activities.DICOM.ProcessRPS
{

    /// <summary> </summary>
    [PopulateRPSTablesActivity_DisplayName]
    [DICOM_ActivityGroup]
    [RPS_Category]
    public class PopulateRPSTablesActivity : MosaiqCodeActivity
    {
        [Import]
        private IProcessRPS _processRPS;
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            string localStatus = _processRPS.PopulateRPSTables(UnitId.Get(context));
