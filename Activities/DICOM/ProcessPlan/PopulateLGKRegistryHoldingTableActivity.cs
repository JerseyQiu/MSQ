...
namespace Impac.Mosaiq.IQ.Activities.DICOM.ProcessPlan
{
    ...
    /// <summary> </summary>
    [PopulateLGKRegistryHoldingTableActivity_DisplayName]
    [DICOM_ActivityGroup]
    [RTPlan_Category]
    public class PopulateLGKRegistryHoldingTableActivity : MosaiqCodeActivity
    {
        [Import]
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            string localStatus = _processConventionalPlan.ProcessGammaPlanPopulateLGKRegistryTable(UnitId.Get(context));
