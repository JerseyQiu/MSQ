...
{
    partial class NoteTypeSelector
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(NoteTypeSelector));
			...
			this.listNoteTypes = new DevExpress.XtraEditors.ListBoxControl();
			...
			((System.ComponentModel.ISupportInitialize) (this.listNoteTypes)).BeginInit();
			...
			this.layoutControlGroup1.Size = new System.Drawing.Size(262, 394);
			...
			// impacLayoutControl2
			// 
			this.impacLayoutControl2.Controls.Add(this.listNoteTypes);
			this.impacLayoutControl2.Controls.Add(this.checkAll);
			...
			// listNoteTypes
			// 
			this.listNoteTypes.Appearance.Font = new System.Drawing.Font("Arial", 9F);
			this.listNoteTypes.Appearance.Options.UseFont = true;
			resources.ApplyResources(this.listNoteTypes, "listNoteTypes");
			this.listNoteTypes.Name = "listNoteTypes";
			this.listNoteTypes.SelectionMode = System.Windows.Forms.SelectionMode.MultiSimple;
			this.listNoteTypes.StyleController = this.impacLayoutControl2;
			// 
			// checkAll
			// 
			resources.ApplyResources(this.checkAll, "checkAll");
			this.checkAll.Name = "checkAll";
			this.checkAll.Properties.Appearance.BackColor = System.Drawing.Color.Transparent;
			this.checkAll.Properties.Appearance.Font = new System.Drawing.Font("Arial", 9F);
			this.checkAll.Properties.Appearance.Options.UseBackColor = true;
			this.checkAll.Properties.Appearance.Options.UseFont = true;
			this.checkAll.Properties.Caption = resources.GetString("checkAll.Properties.Caption");
			this.checkAll.StyleController = this.impacLayoutControl2;
			...
			this.layoutControlGroup2.Size = new System.Drawing.Size(262, 394);
			...
			this.layoutControlItem2.Control = this.checkAll;
			...
			this.layoutControlItem1.Control = this.listNoteTypes;
			resources.ApplyResources(this.layoutControlItem1, "layoutControlItem1");
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Padding = new DevExpress.XtraLayout.Utils.Padding(5, 5, 5, 5);
			this.layoutControlItem1.Size = new System.Drawing.Size(260, 361);
			...
			this.Name = "NoteTypeSelector";
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.Load += new System.EventHandler(this.NoteTypeSelector_Load);
			...
			((System.ComponentModel.ISupportInitialize) (this.listNoteTypes)).EndInit();
		...
		private DevExpress.XtraEditors.ListBoxControl listNoteTypes;
