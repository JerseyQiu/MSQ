...
namespace Impac.Mosaiq.IQ.Activities.Variables.PM
{
    ...
    /// </summary>
    [IQStaffLocVarActivity_DisplayName]
    [PracticeManagement_Category]
    [Variables_ActivityGroup]
    public sealed class IQStaffLocVarActivity : IQVariableActivityEntity<int, Staff, IQIntegerVar, IQStaffVarDetail, IQStaffLocVarConfig>
    {
    ...
    [Serializable]
    public class IQStaffLocVarConfig : IQVariableConfigEntity<int, Staff, IQIntegerVar, IQStaffVarDetail>
    {
        /// <summary>
