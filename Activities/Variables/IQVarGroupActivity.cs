...
{
    /// <summary>
    /// This is a custom sequence activity which can only contain child activities which implement the IInitVarActivity
    /// interface.  It is used to provide metadata used for grouping arguments together in the IQScriptDialog UI.
    /// </summary>
    [IQVarGroupActivity_DisplayName]
    [Utilities_Category]
    [Designer(typeof(IQVarGroupActivityDesigner))]
    [ContentProperty("Activities")]
    [MosaiqActivity]
    [Variables_ActivityGroup]
    public sealed class IQVarGroupActivity : MosaiqNativeActivity, IIQVarGroupActivity
    {
        #region Constructor

        /// <summary> Default Ctor</summary>
        public IQVarGroupActivity()
        {
        ...
        /// activity class.
        /// </summary>
        [IQVarGroupActivity_DisplayName_Description]
        ...
        protected override void CacheMetadata(NativeActivityMetadata metadata)
        {
            ...
            if (Activities.Count <= 0)
                metadata.AddValidationError(Strings.IQVarGroupActivity_MustHaveActivity);

            if (Activities.Any(act => !(act is IIQVarActivity)))
                metadata.AddValidationError(Strings.IQVarGroupActivity_OnlyIQVariableActivitiesAllowed);
        }
