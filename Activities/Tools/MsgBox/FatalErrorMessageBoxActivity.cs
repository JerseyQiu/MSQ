...
{
    /// <summary> Activity used to display a fatal error message </summary>
    [FatalErrorMessageBoxActivity_DisplayName]
    [Messaging_Category]
    [Tools_ActivityGroup]
    public class FatalErrorMessageBoxActivity : MosaiqUICodeActivity
    {
        #region Properties
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            if(String.IsNullOrWhiteSpace(caption))
                XlateMessageBox.FatalError(message);
            else
                XlateMessageBox.FatalError(message, caption);
        }
        #endregion
    }
}