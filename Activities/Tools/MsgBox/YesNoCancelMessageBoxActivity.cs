...
{
    /// <summary> Activity used to display a Yes/No/Cancel message </summary>
    [YesNoCancelMessageBoxActivity_DisplayName]
    [Messaging_Category]
    [Tools_ActivityGroup]
    public class YesNoCancelMessageBoxActivity : MosaiqUICodeActivity
    {
        #region Properties
        ...
        public OutArgument<YesNoCancelDialogResult> DialogResult { get; set; }
        #endregion
