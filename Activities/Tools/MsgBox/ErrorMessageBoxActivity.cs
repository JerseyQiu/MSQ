...
{
    /// <summary> Activity used to display an error denied message </summary>
    [ErrorMessageBoxActivity_DisplayName]
    [Messaging_Category]
    [Tools_ActivityGroup]
    public class ErrorMessageBoxActivity : MosaiqUICodeActivity
    {
        #region Properties
