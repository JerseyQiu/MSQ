...
{
    /// <summary> Activity used to display a Yes All / No / Cancel message </summary>
    [YesAllNoCancelMessageBoxActivity_DisplayName]
    [Messaging_Category]
    [Tools_ActivityGroup]
    public class YesAllNoCancelMessageBoxActivity : MosaiqUICodeActivity
    {
        #region Properties
        ...
        public OutArgument<YesAllNoDialogResult> DialogResult { get; set; }
        #endregion
        ...
        protected override void DoWork(CodeActivityContext context)
        {
            ...
            //Heavy Lifting
            YesAllNoDialogResult result = XlateMessageBox.YesAllNoCancel(message, caption, defaultButtons);
