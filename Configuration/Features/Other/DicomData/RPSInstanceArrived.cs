...
{
    class RPSInstanceArrived : ScriptFeatureBase
    {
        ...
        {
            get { return ScriptFeatureGuids.RPSInstanceArrived; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.RPSInstanceArrived_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.RPSInstanceArrived_Description; }
        }
        ...
        {
            scriptTypeGuids.Add(ScriptTypeGuids.RPSInstanceScript);
        }
