...
{
    class PETSeriesArrived : ScriptFeatureBase
    {
        ...
        {
            get { return ScriptFeatureGuids.PETSeriesArrived; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PETSeriesArrived_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PETSeriesArrived_Description; }
        }
        ...
        {
            scriptTypeGuids.Add(ScriptTypeGuids.ImageSeriesScript);
        }
