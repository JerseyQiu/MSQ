...
{
    class MRSeriesArrived : ScriptFeatureBase
    {
        ...
        {
            get { return ScriptFeatureGuids.MRSeriesArrived; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.MRSeriesArrived_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.MRSeriesArrived_Description; }
        }
