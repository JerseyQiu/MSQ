...
{
    class RTDoseInstanceArrived : ScriptFeatureBase
    {
        ...
        {
            get { return ScriptFeatureGuids.RTDoseInstanceArrived; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.RTDoseInstanceArrived_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.RTDoseInstanceArrived_Description; }
        }
        ...
        {
            scriptTypeGuids.Add(ScriptTypeGuids.RTDoseInstanceScript);
       }
