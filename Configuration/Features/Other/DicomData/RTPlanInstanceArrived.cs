...
{
    class RTPlanInstanceArrived : ScriptFeatureBase
    {
        ...
        {
            get { return ScriptFeatureGuids.RTPlanInstanceArrived; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.RTPlanInstanceArrived_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.RTPlanInstanceArrived_Description; }
        }
        ...
        {
            scriptTypeGuids.Add(ScriptTypeGuids.RTPlanInstanceScript);
        }
