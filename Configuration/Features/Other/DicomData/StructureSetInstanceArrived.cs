...
{
    class StructureSetInstanceArrived : ScriptFeatureBase
    {
        ...
        {
            get { return ScriptFeatureGuids.StructureSetInstanceArrived; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.StructureSetInstanceArrived_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.StructureSetInstanceArrived_Description; }
        }
        ...
        {
            scriptTypeGuids.Add(ScriptTypeGuids.StructureSetInstanceScript);
        }
