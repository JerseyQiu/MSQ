...
{
    class CTSeriesArrived : ScriptFeatureBase
    {
        ...
        {
            get { return ScriptFeatureGuids.CTSeriesArrived;  }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.CTSeriesArrived_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.CTSeriesArrived_Description; }
        }
