...
{
    class IViewGTAutoIsocenter : ScriptFeatureBase
    {
        ...
        {
            get { return ScriptFeatureGuids.IViewGTAutoIsocenter; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.IViewGTAutoIsocenter_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.IViewGTAutoIsocenter_Description; }
        }
        ...
        {
            scriptTypeGuids.Add(ScriptTypeGuids.IViewGTAutoIsocenterScript);
        }
