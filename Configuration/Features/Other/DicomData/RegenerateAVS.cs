...
{
    class RegenerateAVS : ScriptFeatureBase
    {
        ...
        {
            get { return ScriptFeatureGuids.RegenerateAVS;  }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.RegenerateAVS_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.RegenerateAVS_Description; }
        }
        ...
        {
            scriptTypeGuids.Add(ScriptTypeGuids.RegenerateAVSScript);
        }
