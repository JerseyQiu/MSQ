...
namespace Impac.Mosaiq.IQ.Configuration.Features.Business.RadiationOncology.TreatmentChart
{
    ...
    public sealed class DoseChartPotdTreat : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PotdTreat; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.RODoseChartPotdTreat; } 
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.RODoseChartPotdTreat_Description; }
        }
        ...
        {
            scriptTypeGuids.Add(ScriptTypeGuids.PotdScriptCancelable);
        }
