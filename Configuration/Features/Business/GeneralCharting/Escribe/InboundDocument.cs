...
{
	class InboundDocument : BusinessScriptFeature
	{
		...
		{
			get { return ScriptFeatureGuids.InboundDocument; }
		}

		/// <summary> The display name of this feature </summary>
		public override string Name
		{
			get { return Strings.InboudDocument_Name; }
		}

		/// <summary> The display description of this feature </summary>
		public override string Description
		{
			get { return Strings.InboundDocument_Description; }
		}
		...
		protected override void GetSupportedScriptTypeGuids(IList<Guid> scriptTypeGuids)
		{
			...
			scriptTypeGuids.Add(ScriptTypeGuids.DocumentScript);
		}
		#endregion
	}
}
