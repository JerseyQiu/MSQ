...
{
    class QclSkipped : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.QclSkipped; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.QclSkipped_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.QclSkipped_Description; }
        }
