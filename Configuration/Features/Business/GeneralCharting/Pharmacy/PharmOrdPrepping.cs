...
{
    class PharmOrdPrepping : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PharmOrdPrepping; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PharmOrdPrepping_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PharmOrdPrepping_Description; }
        }
