...
{
    class PharmOrdCreated : DecisionSupportScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PharmOrdCreated; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PharmOrdCreated_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PharmOrdCreated_Description; }
        }
