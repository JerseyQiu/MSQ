...
{
    class PharmOrdPrepped : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PharmOrdPrepped; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PharmOrdPrepped_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PharmOrdPrepped_Description; }
        }
