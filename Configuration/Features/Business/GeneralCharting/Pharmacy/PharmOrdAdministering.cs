...
{
    /// <summary> </summary>
    public class PharmOrdAdministering : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PharmOrdAdministering; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PharmOrdAdministering_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PharmOrdAdministering_Description; }
        }
