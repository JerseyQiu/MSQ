...
{
    class PharmOrdVerified : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PharmOrdVerified; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PharmOrdVerified_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PharmOrdVerified_Description; }
        }
