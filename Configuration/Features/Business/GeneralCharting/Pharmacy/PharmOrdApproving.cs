...
namespace Impac.Mosaiq.IQ.Configuration.Features.Business.GeneralCharting.Pharmacy
{
    ...
    public sealed class PharmOrdApproving : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PharmOrdApproving; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PharmOrdApproving_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PharmOrdApproving_Description; }
        }
