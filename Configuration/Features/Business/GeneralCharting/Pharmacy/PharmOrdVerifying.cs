...
{
    /// <summary> </summary>
    public class PharmOrdVerifying : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PharmOrdVerifying; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PharmOrdVerifying_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PharmOrdVerifying_Description; }
        }
