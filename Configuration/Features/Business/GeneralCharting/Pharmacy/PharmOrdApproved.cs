...
{
    class PharmOrdApproved : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PharmOrdApproved; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PharmOrdApproved_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PharmOrdApproved_Description; }
        }
