...
{
    /// <summary> Defines the script feature for pharmacy order approval </summary>
    public sealed class PharmOrdMarkingReadyToTreat : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.PharmOrdMarkingReadyToTreat; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.PharmOrdMarkingReadyToTreat_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.PharmOrdMarkingReadyToTreat_Description; }
        }
        ...
        protected override void  GetSupportedScriptTypeGuids(IList<Guid> scriptTypeGuids)
        {
            ...
            scriptTypeGuids.Add(ScriptTypeGuids.OrderScriptCancelable);
        }
        #endregion
    }
}