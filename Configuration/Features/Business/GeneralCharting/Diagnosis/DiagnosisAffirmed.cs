...
namespace Impac.Mosaiq.IQ.Configuration.Features.Business.GeneralCharting.Diagnosis
{
	class DiagnosisAffirmed : BusinessScriptFeature
	{
		...
		{
			get { return ScriptFeatureGuids.DiagnosisAffirmed; }
		}

		/// <summary> The display name of this feature </summary>
		public override string Name
		{
			get { return Strings.DiagnosisAffirmed_Name; }
		}

		/// <summary> The display description of this feature </summary>
		public override string Description
		{
			get { return Strings.DiagnosisAffirmed_Description; }
		}
		...
		{
			get { return Strings.SubCategory_Diagnosis; }
		}
		...
		protected override void GetSupportedScriptTypeGuids(IList<Guid> scriptTypeGuids)
		{
			...
			scriptTypeGuids.Add(ScriptTypeGuids.DiagnosisScript);
		}
		#endregion
	}
}
