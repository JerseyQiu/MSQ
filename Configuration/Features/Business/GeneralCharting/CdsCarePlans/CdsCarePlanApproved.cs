...
{
    /// <summary>
    /// IQ script trigger for when CDS care plan is imported, approved, and assigned to a patient.
    /// </summary>
    /// <seealso cref="BusinessScriptFeature" />
    class CdsCarePlanApproved : BusinessScriptFeature
    {
        #region Overridden Properties
        /// <summary> The application event guid </summary>
        public override Guid Guid
        {
            get { return ScriptFeatureGuids.CdsCarePlanApproved; }
        }

        /// <summary> The application event name </summary>
        public override string Name
        {
            get { return Strings.CdsCarePlanApproved_Name; }
        }

        /// <summary> The application event description </summary>
        public override string Description
        {
            get { return Strings.CdsCarePlanApproved_Description; }
        }
