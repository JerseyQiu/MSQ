...
{
    class ObsOrdMarkingReadyToTreat : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.ObsOrdMarkingReadyToTreat; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.ObsOrdMarkingReadyToTreat_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.ObsOrdMarkingReadyToTreat_Description; }
        }
