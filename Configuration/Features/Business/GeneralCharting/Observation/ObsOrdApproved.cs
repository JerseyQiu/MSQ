...
{
    class ObsOrdApproved : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.ObsOrderApproved; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.ObsOrdApproved_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.ObsOrdApproved_Description; }
        }
