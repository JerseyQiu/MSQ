...
{
    class ObsOrdCreated : DecisionSupportScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.ObsOrderCreated; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.ObsOrdCreated_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.ObsOrdCreated_Description; }
        }
