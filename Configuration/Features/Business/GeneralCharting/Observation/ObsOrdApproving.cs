...
{
    class ObsOrdApproving : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.ObsOrderApproving; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.ObsOrdApproving_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.ObsOrdApproving_Description; }
        }
