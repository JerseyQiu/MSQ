...
namespace Impac.Mosaiq.IQ.Configuration.Features.DecisionSupport.Observation
{
    class ObsOrdModified : DecisionSupportScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.ObsOrderModified; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.ObsOrdModified_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.ObsOrdModified_Description; }
        }
