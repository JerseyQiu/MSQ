...
{
    class SchAppointmentEnded : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.SchAppointmentEnded; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.SchAppointmentEnded_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.SchAppointementEnded_Description; }
        }
