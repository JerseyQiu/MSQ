...
{
    class SchPatientQueued : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.SchPatientQueued; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.SchPatientQueued_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.SchPatientQueued_Description; }
        }
