...
{
    class ObsDataReviewed : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.ObsDataReviewed; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.ObsDataReviewed_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.ObsDataReviewed_Description; }
        }
