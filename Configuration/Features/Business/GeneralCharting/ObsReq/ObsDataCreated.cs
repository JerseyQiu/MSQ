...
namespace Impac.Mosaiq.IQ.Configuration.Features.Business.GeneralCharting.ObsReq
{
    class ObsDataCreated : BusinessScriptFeature
    {
        ...
        {
            get { return ScriptFeatureGuids.ObsDataCreated; }
        }

        /// <summary> The display name of this feature </summary>
        public override string Name
        {
            get { return Strings.ObsDataCreated_Name; }
        }

        /// <summary> The display description of this feature </summary>
        public override string Description
        {
            get { return Strings.ObsDataCreated_Description; }
        }
        ...
        {
            get { return Strings.SubCategory_ObsReq; }
        }
        ...
        protected override void GetSupportedScriptTypeGuids(IList<Guid> scriptTypeGuids)
        {
            ...
            scriptTypeGuids.Add(ScriptTypeGuids.ObsReqScript);
        }
        #endregion
    }
}
