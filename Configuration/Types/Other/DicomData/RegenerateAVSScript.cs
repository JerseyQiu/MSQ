...
{
    class RegenerateAVSScript : DicomScriptTypeBase
    {
        ...
        {
            get { return ScriptTypeGuids.RegenerateAVSScript; }
        }

        /// <summary> The display name of this script type </summary>
        public override string Name
        {
            get { return Strings.RegenerateAVSScript_Name; }
        }

        /// <summary> The display description of this script type </summary>
        public override string Description
        {
            get { return Strings.RegenerateAVSScript_Description; }
        }
