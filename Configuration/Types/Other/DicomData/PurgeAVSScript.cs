...
{
    class PurgeAVSScript : DicomScriptTypeBase
    {
        ...
        {
            get { return ScriptTypeGuids.PurgeAVSScript; }
        }

        /// <summary> The display name of this script type </summary>
        public override string Name
        {
            get { return Strings.PurgeAVSScript_Name; }
        }

        /// <summary> The display description of this script type </summary>
        public override string Description
        {
            get { return Strings.PurgeAVSScript_Description; }
        }
