...
{
    class StructureSetInstanceScript : DicomScriptTypeBase
    {
        ...
        {
            get { return ScriptTypeGuids.StructureSetInstanceScript; }
        }

        /// <summary> The display name of this script type </summary>
        public override string Name
        {
            get { return Strings.StructureSetInstanceScript_Name; }
        }

        /// <summary> The display description of this script type </summary>
        public override string Description
        {
            get { return Strings.StructureSetInstanceScript_Description; }
        }
