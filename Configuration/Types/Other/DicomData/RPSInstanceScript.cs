...
{
    class RPSInstanceScript : DicomScriptTypeBase
    {
        ...
        {
            get { return ScriptTypeGuids.RPSInstanceScript; }
        }

        /// <summary> The display name of this script type </summary>
        public override string Name
        {
            get { return Strings.RPSInstanceScript_Name; }
        }

        /// <summary> The display description of this script type </summary>
        public override string Description
        {
            get { return Strings.RPSInstanceScript_Description; }
        }
