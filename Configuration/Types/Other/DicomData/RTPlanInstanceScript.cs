...
{
    class RTPlanInstanceScript : DicomScriptTypeBase
    {
        ...
        {
            get { return ScriptTypeGuids.RTPlanInstanceScript; }
        }

        /// <summary> The display name of this script type </summary>
        public override string Name
        {
            get { return Strings.RTPlanInstanceScript_Name; }
        }

        /// <summary> The display description of this script type </summary>
        public override string Description
        {
            get { return Strings.RTPlanInstanceScript_Description; }
        }
