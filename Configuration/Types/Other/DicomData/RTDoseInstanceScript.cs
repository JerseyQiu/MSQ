...
{
    class RTDoseInstanceScript : DicomScriptTypeBase
    {
        ...
        {
            get { return ScriptTypeGuids.RTDoseInstanceScript; }
        }

        /// <summary> The display name of this script type </summary>
        public override string Name
        {
            get { return Strings.RTDoseInstanceScript_Name; }
        }

        /// <summary> The display description of this script type </summary>
        public override string Description
        {
            get { return Strings.RTDoseInstanceScript_Description; }
        }
