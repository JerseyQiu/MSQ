...
{
	/// <summary> Defines a script type which can be invoked from an ObsReq trigger</summary>
	public sealed class ObsReqScript : BusinessScriptType
	{
		/// <summary> The unique identifier for this script type. </summary>
		public override Guid Guid
		{
			get { return ScriptTypeGuids.ObsReqScript; }
		}

		/// <summary> The display name of this script type </summary>
		public override string Name
		{
			get { return Strings.ObsReqScript_Name; }
		}

		/// <summary> The display description of this script type </summary>
		public override string Description
		{
			get { return Strings.ObsReqScript_Description; }
		}
		...
		{
			yield return new IQInArgument<int>(ScriptTypeConstants.ArgObrId);
		}
	}
}
