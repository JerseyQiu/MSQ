...
namespace Impac.Mosaiq.IQ.Configuration.Types.Business.GeneralCharting
{
    ...
    public sealed class AppointmentScript : BusinessScriptType
    {
        /// <summary> The unique identifier for this script type. </summary>
        public override Guid Guid
        {
            get { return ScriptTypeGuids.AppointmentScript; }
        }

        /// <summary> The display name of this script type </summary>
        public override string Name
        {
            get { return Strings.AppointmentScript_Name; }
        }

        /// <summary> The display description of this script type </summary>
        public override string Description
        {
            get { return Strings.AppointmentScript_Description; }
        }
        ...
        {
            yield return new IQInArgument<int>(ScriptTypeConstants.ArgSchId);
        }
