...
{
	/// <summary> 
	/// Defines a script type which can be invoked from an eScribe Select Template trigger
	/// </summary>
	public sealed class EscribeSelectTemplateScript : BusinessScriptType
	{
		/// <summary> The unique identifier for this script type. </summary>
		public override Guid Guid
		{
			get { return ScriptTypeGuids.EscribeSelectTemplate; }
		}

		/// <summary> The display name of this script type </summary>
		public override string Name
		{
			get { return Strings.EscribeSelectTemplate_Name; }
		}

		/// <summary> The display description of this script type </summary>
		public override string Description
		{
			get { return Strings.EscribeSelectTemplate_Description; }
		}
		...
		public override IEnumerable<IQArgument> GetScriptArguments()
		{
			...
			yield return new IQInArgument<int>(ScriptTypeConstants.ArgDocumentType);
			yield return new IQOutArgument<string>(ScriptTypeConstants.ArgSelectedTemplate);
		}
	}
}
