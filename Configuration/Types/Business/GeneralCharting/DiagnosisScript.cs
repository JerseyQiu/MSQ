...
{
	/// <summary> Defines a script type which can be invoked from any diagnosis trigger</summary>
	public sealed class DiagnosisScript : BusinessScriptType
	{
		/// <summary> The unique identifier for this script type. </summary>
		public override Guid Guid
		{
			get { return ScriptTypeGuids.DiagnosisScript; }
		}

		/// <summary> The display name of this script type </summary>
		public override string Name
		{
			get { return Strings.DiagnosisScript_Name; }
		}

		/// <summary> The display description of this script type </summary>
		public override string Description
		{
			get { return Strings.DiagnosisScript_Description; }
		}
		...
		{
			yield return new IQInArgument<int>(ScriptTypeConstants.ArgMedId);
		}
